const { JsonWebSignature2020, JsonWebKeyLinkedDataKeyClass2020 } = require('lds-jws2020');
...
const getKey = (verificationMethod) => {
    ...
    switch (verificationMethod) {
        case 'did:web:vc.transmute.world#z6MksHh7qHWvybLg5QTPPdG2DgEjjduBDArV9EF9mRiRzMBN':
            return key = new Ed25519KeyPair({
                ...privateKey,
                ...verificationMethodPublicKey,
            });
        case verificationMethodPublicKey.id:
            const privateKeyJwk = getPrivateKeyJwk(verificationMethodPublicKey.publicKeyJwk.kid)
...
const getSuite = (options) => {
    ...
    switch (verificationMethod.type) {
        ...
        default:
            throw new Error('No Suite for: ' + suiteName)
    }
}
